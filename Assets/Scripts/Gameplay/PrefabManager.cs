...
public class PrefabManager : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        // (Guard against empty neighbor lanes — e.g. during the tutorial the lane pools are empty.)
        ...
        // (Guard against empty lane lists — e.g. during the tutorial the lane pools are empty.)
        if (Time.time - startTime > 1)
        {
